...
function buscarUltimasMedidasHora(req, res) {
  ...
  medidaModel
    .buscarUltimasMedidasHora(idEmpresa)
...
function semanasMes(req, res) {
  var idEmpresa = req.params.idEmpresa;

  console.log(`Recuperando as ultimas medidas`);

  medidaModel
    .semanasMes(idEmpresa)
    .then(function (resultado) {
      if (resultado.length > 0) {
        res.status(200).json(resultado);
      } else {
...
function buscarUltimasMedidasAnos(req, res) {
  ...
  medidaModel
    .buscarUltimasMedidasAnos(idEmpresa)
    .then(function (resultado) {
      if (resultado.length > 0) {
        res.status(200).json(resultado);
      } else {
...
function buscarUltimasMedidasDia(req, res) {
  ...
  medidaModel
    .buscarUltimasMedidasDia(idEmpresa)
    .then(function (resultado) {
      if (resultado.length > 0) {
        res.status(200).json(resultado);
      } else {
