            ...
            if (AMBIENTE == 'producao') {
                ...
                if (chave == 1) {
                    ...
                    tempo =
                        ...
                        sqlquery = `INSERT INTO tbMovimentacao (dataHora, fkSensor) VALUES(DATEADD(HOUR,-3,GETDATE()), ${sensor})`;

                    // CREDENCIAIS DO BANCO REMOTO - SQL SERVER
                    const connStr = "Server=grupo2-1cco.database.windows.net;Database=SentinelTrack;User Id=grupo2-1cco;Password=#Gfsentineltrack;";
